      ...
      <DialogContent>
        <Hbox align="flex-start">
          <div className={classes.image}>
            <Image
              fill
              src={get(brand, 'media.thumbnail.src') || get(product, 'thumbnail.src')}
              alt={get(brand, 'media.thumbnail.alt') || get(product, 'thumbnail.alt')}
            />
          </div>
          <div className={classes.info}>
            <Typography className={classes.name}>{product.name}</Typography>
            <Typography>{brand.text ? `Brand: ${brand.text}` : ''}</Typography>
