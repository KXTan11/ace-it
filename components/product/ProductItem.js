      ...
      <Vbox alignItems="stretch">
        <ForwardThumbnail>
          <Link
            ...
            prefetch="visible"
            pageData={{ product, brand: store.brand }}
          >
            <a>
              <Image
                className={classes.thumbnail}
                src={
                  (store.brand && store.brand.media.thumbnail.src) ||
                  (store.thumbnail && store.thumbnail.src)
                }
                alt={
                  (store.brand && store.brand.media.thumbnail.alt) ||
        ...
        <div className={classes.info}>
          ...
          {colorSelector && (
            <ProductOptionSelector
              ...
              value={store.color}
              onChange={value => updateStore({ ...store, brand: value })}
              optionProps={{
                size: 'small',
                showLabel: false,
              }}
